...
class _AdminPlacesPageState extends State<AdminPlacesPage> {
  ...
  Widget build(BuildContext context) {
    ...
    //       return Scaffold(
    //         body: Center(
    //           child: Text("Jaringan tidak stabli"),
    //         ),
    //       );
    //     } else if (snapshot.connectionState == ConnectionState.done) {
    //       if (penghubung.mydata != null) {
    //         penghubung.readdata();
    //         perbaruidata();
    //       }
    //     }
    ...
    //                                                                           backgroundColor: _isNameFilled && _isCoordValid ? const Color(0xFF12111F) : Colors.grey.shade400,
    //                                                                           shape: RoundedRectangleBorder(
    //                                                                             borderRadius: BorderRadius.circular(50),
    //                                                                           ),
    //                                                                         ),
    ...
    //                                                       'Hapus Tempat?'),
    //                                                   content: Text(
    //                                                     'Yakin ingin menghapus tempat "nama"? Tindakan ini tidak dapat dibatalkan.',
    //                                                   ),
    //                                                   actions: [
    //                                                     TextButton(
    //                                                       onPressed: () =>
